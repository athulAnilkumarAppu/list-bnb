    ...
    <div className="page">
      ...
      <div className="login-wrapper">
        <div className="login-form">
          ...
          <button className="form-login-btn" onClick={() => onRegisterClick()}>
            Register
            <svg
              width="15"
              height="10"
        ...
        <div className="register-panel">
          ...
          <h3 className="register-title">Already Have an Account?</h3>
          <p className="register-text">
            To connect with us please login to our account if you are having one
            already
          </p>
          <button className="register-btn" onClick={() => onLoginClick()}>
            Login
            <svg
              width="15"
              height="10"
