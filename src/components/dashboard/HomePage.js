    ...
    <>
      ...
      <div className="hero-section">
        <h1 className="hero-title">
          Get daily thing in same <span className="highlight">platform</span>
        </h1>
      ...
      <div className="section-header">
        <h4 className="section-subtitle">What’s new</h4>
        <h1 className="section-title">Fresh Recommendations</h1>
      </div>

      <div className="ad-list">
        <span className="item-count">{itemsCount} Items</span>
        {adList?.length > 0 &&
          adList.map((item) => {
            return (
              <div className="ad-card" onClick={(item) => onAdClick(item)}>
                <img src={item.image} alt="prod-img" className="ad-image" />
